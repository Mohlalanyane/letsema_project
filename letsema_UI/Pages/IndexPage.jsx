      ...
      <div>
          <nav class="navbar navbar-expand-lg bg-body-tertiary">
              <div class="container-fluid">
                  <a class="navbar-brand fw-bold"style={{color:' #1f2a3e'}} href="#">Letsema</a>
                  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
                      <span class="navbar-toggler-icon"></span>
                  </button>
                  <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarNavDropdown">
                      <ul class="navbar-nav gap-3 d-flex justify-content-between" id="list">
                          <li class="nav-item " >
                              <NavLink class="nav-link text-dark active" aria-current="page" to="/" >Home</NavLink>
                          </li>
                          <li class="nav-item">
                              <NavLink class="nav-link text-dark" to="/signin">Sign in</NavLink>
                          </li>
                          <li class="nav-item">
                              <NavLink class="nav-link text-dark" to="/signup">Sign Up</NavLink>
                          </li>
                          <li class="nav-item">
                              <NavLink class="nav-link text-dark" to="/officer_signup">Sign Up As Officer</NavLink>
                          </li>
                          <li class="nav-item">
                              <NavLink class="nav-link text-dark" to="/mfi_signup">Register MFI</NavLink>
                          </li>
                      </ul>
                  </div>
              </div>
          ...
          <div class="container text-center">
              <div class="row mt-5">
                  <div class="col">
                      ...
                      <p className="display-5 fw-bold" style={{color:' #1f2a3e'}}>Microfinance Management</p>
